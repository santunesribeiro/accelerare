...
class Googlemaps {
    ...
    var $adsense = true;      // Whether Google Adsense For Content should be enabled
    ...
    var $kmlLayerPreserveViewport = TRUE;     // Specifies whether the map should be adjusted to the bounds of the KmlLayer's contents. By default the map is zoomed and positioned to show the entirety of the layer's contents
    ...
    function get_lat_long_from_address($address, $attempts = 0) {
        ...
        $data_location .= "maps.google.com/maps/api/geocode/json?address=" . urlencode(utf8_encode($address)) . "&sensor=" . $this->sensor. "&key=AIzaSyBVRs588jPNOQCqvsCGk0v-3pFwtOIFuZ4";
        if ($this->region != "" && strlen($this->region) == 2) {
